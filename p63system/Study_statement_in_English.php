...
$query_appata = "SELECT service_id FROM `p63_services` WHERE service_name='افاده دراسه باللغه الانجليزيه'";
...
<head>
    ...
    <title>طلب افاده دراسه باللغه الانجليزيه</title>
</head>
...
<body>
    ...
    <div class="register col-lg-6">
        <header>
            <h1 >طلب افاده دراسه باللغه الانجليزيه <i class="fa-regular fa-id-card"></i></h1>
        </header>
        <form method="post">
            <div class="form-row">
                <div class="col">
            ...
            <div class="form-row">
                <div class="col">
                    ...
                    <input name="addressed" required type="text" class="form-control" placeholder="موجه الى">
                </div>
                <div class="col">
                    <label>الهاتف</label>
