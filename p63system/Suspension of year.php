...
$query_appata = "SELECT p63_services.service_id 
FROM p63_services
WHERE p63_services.service_name='ايقاف قيد عن سنه دراسيه';";
...
if(isset($_POST['send']))
{
   ...
   //seen sent seccussfully message 
...
<head>
    ...
    <title>طلب ايقاف قيد عن سنه دراسيه </title>
</head>
...
<body>
    ...
    <div class="register col-lg-6">
        <header>
            <h1 >طلب ايقاف قيد عن سنه دراسيه <i class="fa-regular fa-id-card"></i></h1>
        </header>
        <form method="post">
            <div class="form-row">
                <div class="col">
