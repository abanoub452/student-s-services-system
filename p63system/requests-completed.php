...
//selct data that recieve the order
...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="">الصفحه</a></li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">طلبات تم الانتهاء منها ولم تستلم بعد</h5>
              <!-- Table with stripped rows -->
              <table class="table datatable">
                <thead>
                  <tr>
                    <th scope="col">الموظف المسؤل</th>
                    <th scope="col">تاريخ الانتهاء</th>
                    <th scope="col">تاريخ الدفع</th>
                    <th scope="col"> صوره الخدمه</th>
                ...
                <?php foreach($s as $data):?>
                  <tr>
                    ...
                    <td> <img width=100px; src="upload/<?= $data['scan_order_img']?>" alt=""></td>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">طلبات تم استلامها  </h5>
              <!-- Table with stripped rows -->
              <table class="table datatable">
                <thead>
                  <tr>
                    <th scope="col">وقت الانتظار منذ التقديم الى الانتهاء</th>
                    <th scope="col">الموظف المسئول</th>
                    <th scope="col">تاريخ الاستلام</th>
                    <th scope="col">تاريخ الانتهاء</th>
                    <th scope="col">تاريخ مراجعه الايصال</th>
                    <th scope="col">تاريخ الدفع</th>
                    <th scope="col">تاريخ ارسال كود الدفع</th>
                ...
                <?php foreach($snn as $data):?>
                  <tr>
                  <?php
                    // cacluate waiting time
                        // Create DateTime objects for the two dates
                        $date1 = new DateTime($data['check_receipt_date']);
                        $date2 = new DateTime($data['finish_order_date']);

                        // Calculate the difference between the two dates as a DateInterval object
                        $interval = $date1->diff($date2);
                        ?>

                        <!-- // Output the waiting time in days, hours, minutes and seconds -->
