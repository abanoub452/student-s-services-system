...
JOIN users 
ON (users.user_id=p63_order.done_by_user)
where p63_order_statuses.order_status_id = 6 OR p63_order_statuses.order_status_id = 7
ORDER BY p63_order.apply_date;

";
$srr = mysqli_query($bis , $selcet);
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">الطلبات المقدمه ولم يتم ارسال كود دفع لها</h5>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">الطلبات المقدمه وتم ارسال كود دفع لها</h5>
              <!-- Table with stripped rows -->
              <table class="table datatable">
                <thead>
                  <tr>
                    <th scope="col">الموظف المسؤل</th>
                    <th scope="col">كود الدفع</th>
