...
JOIN users
ON (users.user_id=p63_complain.respond_by)
WHERE p63_complain.complain_respond is NOT null;
";

$com = mysqli_query($bis , $selcet);
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">الشكاوى التى تم الرد عليها </h5>
              <!-- Table with stripped rows -->
              <table class="table datatable">
                <thead>
                  <tr>
                  <tr>
                  <th scope="col"> تاريخ الرد على الشكوى </th>
                    <th scope="col"> تاريخ الشكوى</th>
                    <th scope="col">الموظف القام بالرد على الشكوى</th>
                    <th scope="col">  الرد على الشكوى</th>
                ...
                <?php foreach($com as $data):?>
                  <tr>
                  <td><?=$data['respond_date']?></td>
                    <td><?=$data['complain_date']?></td>
                    <td><?=$data['user_ar_name']?></td>
                    <td><?=$data['complain_respond']?></td>
                    <td><?=$data['complain_text']?></td>
