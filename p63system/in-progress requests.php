...
WHERE payment_code IS NOT null && order_status_id = 3
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">طلبات جارى العمل بها</h5>
              ...
              <table class="table datatable">
                <thead>
                  ...
                  <th scope="col">وقت الانتظار</th>
                    <th scope="col">الموظف القائم على كود الدفع</th>
                  <th scope="col">تاريخ مراجعه الوصل</th>
                ...
                <?php foreach($s as $data):?>
                  <tr>
                    ...
                    // cacluate waiting time
                        ...
                        $date1 = new DateTime($data['payment_date']);
                        $date2 = new DateTime($data['check_receipt_date']);
                    ...
                    <td><?=$interval->format('%a days, %h hours')?></td>
