    ...
    <div class="pagetitle">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">الطلبات المقدمه وتم رفضها </h5>
              <!-- Table with stripped rows -->
              <table class="table datatable">
                <thead>
                  <tr>
                  <th scope="col">الموظف القائم على رفض الطلب</th>
                  <th scope="col"> سبب الرفض</th>
                  <th scope="col">تاريخ الرفض</th>
                ...
                <tbody>
                <?php foreach($srr as $data):?>
                  <tr>
                  <td><?=$data['user_ar_name'] ?></td>
                  <td><?=$data['order_status'] ?></td>
                  <td><?=$data['reject_order_date'] ?> <?=$data['reject_receipt_date'] ?></td>
