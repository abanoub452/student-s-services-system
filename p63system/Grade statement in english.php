...
$query_appata = "SELECT service_id FROM `p63_services` WHERE service_name='بيان درجات باللغه الانجليزيه'";
...
<head>
    ...
    <title>طلب بيان درجات باللغه الانجليزيه</title>
</head>
...
<body>
    ...
    <div class="register col-lg-6">
        <header>
            <h1 >طلب بيان درجات باللغه الانجليزيه <i class="fa-regular fa-id-card"></i></h1>
        </header>
        <form method="post">
            <div class="form-row">
                <div class="col">
