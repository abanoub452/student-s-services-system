...
$query_appata = "SELECT service_id FROM `p63_services` WHERE service_name='بيان درجات'";
...
<body>
    ...
    <div class="register col-lg-6">
        <header>
            <h1 >طلب  بيان درجات <i class="fa-regular fa-id-card"></i></h1>
        </header>
        <form method="post">
            <div class="form-row">
                <div class="col">
